    ...
    return (
        <div style={{background: '#E0E7FF'}}>
                                ...
                                <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                                    ...
                                    <form>
                                        ...
                                        <div className="mt-4 mb-2 sm:mb-4">
                                            <button
                                                type="submit"
                                                className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-secondary hover:bg-secondary-focus focus:shadow-outline focus:outline-none"
                                            >
                                                Cek
                                            </button>
                                        </div>
            ...
            <div className="flex justify-center items-center py-10 px-10 my-5">
                <div class="mockup-window bg-base-300 max-w-2xl md:max-w-3xl shadow-md">
                    <div class="flex flex-col justify-center px-4 py-5 bg-info">
                ...
                <div className="relative grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    {dataTimeline.map((timeline, idx) => (
                        <div key={idx}
                            ...
                            <div className="p-5">
                                <p className="mb-2 font-bold flex items-center"><MdDateRange className={"mr-1"}/>{timeline.date}</p>
