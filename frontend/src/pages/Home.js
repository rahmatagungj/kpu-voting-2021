        ...
        <div style={{background: '#E0E7FF'}}>
            ...
            <div className="relative">
                ...
                <div className="relative bg-opacity-75 bg-primary">
                    <svg viewBox="0 0 1160 163" className="absolute inset-x-0 bottom-0 text-white"
                    ...
                    <div
                        className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-32">
                        <div className="flex flex-col items-center justify-between xl:flex-row">
                            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                                ...
                                <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                                    Pemilihan presiden mahasiswa BEM STKIP Muhammadiyah Kuningan, 2021.
                                </p>
                            </div>
                                ...
                                <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                                    ...
                                    <div className="mt-4 mb-2 sm:mb-4">
                                     <button
                                            ...
                                            disabled={isLoading}
                                            type="submit"
                                            className={isLoading ? "btn border-0 inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-secondary hover:bg-secondary-focus focus:shadow-outline focus:outline-none loading" : "btn border-0 inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-secondary hover:bg-secondary-focus focus:shadow-outline focus:outline-none"}
                                        >
                                            Cek
                                        </button>
                                    </div>
                ...
                <div className="mockup-window bg-base-300 max-w-2xl md:max-w-3xl shadow-md">
                    <div className="flex flex-col justify-center px-4 py-5 bg-info">
                        <h1 className="text-3xl font-bold text-white mb-3">
                            Permira itu apa, <i>sih?</i>
                        </h1>
                        <p className="text-1xl font-medium text-white">
                            Pemilihan Umum Raya adalah kegiatan pemilihan presiden mahasiswa BEM STKIP Muhammadiyah
                            Kuningan sebagai salah satu perwujudan demokrasi Mahasiswa STKIP Muhammadiyah Kuningan.
                        </p>
                    </div>
                </div>
            </div>
          ...
          <span className="relative inline-block">
            ...
            <div
                className="relative px-4 py-3 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-5">
                <div
                    className="absolute inset-x-0 top-0 items-center justify-center hidden overflow-hidden md:flex md:inset-y-0">
                    <svg
                        viewBox="0 0 88 88"
                        className="max-w-screen-xl text-indigo-100"
                    >
                ...
                <div className="relative grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    {dataTimeline.map((timeline, idx) => (
                        <div
                            ...
                            <div className="p-5">
                                <p className="mb-2 font-bold flex items-center"><MdDateRange
                                    className={"mr-1"}/>{timeline.date}</p>
                                <p className="text-sm leading-5 text-gray-900">
                                    {timeline.details}
                                </p>
                            </div>
                            <div
                                className="w-full h-1 ml-auto duration-300 origin-left transform scale-x-0 bg-primary-focus group-hover:scale-x-100"/>
                        </div>
                    ))}
                    {/* End Mapping */}
