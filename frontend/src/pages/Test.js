...
import { MdExitToApp,MdInfo, MdHelp,MdPeople } from "react-icons/md";
        ...
        <main className="bg-gray-100 dark:bg-gray-800 h-screen overflow-hidden relative">
            <div className="shadow-lg bg-base-200 drawer drawer-mobile h-screen">
                ...
                <div className="flex flex-col drawer-content">
                    <header className="w-full h-16 z-40 flex items-center justify-between sticky top-3 z-50 mt-3">
                        <div className="block lg:hidden ml-6">
                            <label htmlFor="my-drawer-2"
                                   className="flex p-2 items-center rounded-full text-gray-400 hover:text-gray-700 bg-white shadow text-md drawer-button lg:hidden">
                                <svg width="20" height="20" className="text-gray-400" fill="currentColor"
                                ...
                                <div className="dropdown dropdown-end">
                                    ...
                                    <ul className="shadow menu dropdown-content bg-base-100 rounded w-52 text-black">
                                        <li className="text-red-700">
                                            <a><MdExitToApp className="mr-3"/>Keluar</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
