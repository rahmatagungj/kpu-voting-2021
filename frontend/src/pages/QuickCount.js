          ...
          <div className="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              ...
              <p className="mb-8 leading-relaxed">
                Rekapitulasi Hasil Pemilihan Sementara presiden mahasiswa BEM
                STKIP Muhammadiyah Kuningan, 2021.
              </p>
              <div className="flex justify-center">
                <button
                  ...
                  className={
                    isLoading
                      ? "btn btn-primary inline-flex text-white border-0 py-2 px-6 focus:outline-none rounded text-lg loading"
                      : "btn btn-primary inline-flex text-white border-0 py-2 px-6 focus:outline-none rounded text-lg"
                  }
                >
                  Lihat
                </button>
        ...
        <>
          ...
          <div className="container mx-auto px-5 pt-8 ">
            <div className="alert alert-info text-white bg-info font-bold">
              <div className="flex-1">
                ...
                <label>
                  Data pada {moment(new Date()).locale("id").format("LLLL")} WIB
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto flex px-5 pt-6 lg:pt-10 pb-10 md:flex-row flex-col">
            <div className="container border-t-4 border-primary bg-white p-5 rounded">
              <h3 className="text-base font-bold text-primary">Informasi</h3>
              <hr className="my-5" />
              <div className="mx-auto container flex w-full  px-5">
                <ul className="list-decimal">
                  ...
                  <li>
                    ...
                    penghitungan perolehan suara, penetapan hasil rekapitulasi
                    penghitungan perolehan suara dilakukan secara terpisah.
                  </li>
                  <li>
                    Apabila terdapat perbedaan data yang terbaca oleh Sistem
                    pendataan dengan data yang tertulis, akan dilakukan koreksi
                    pada Sistem Web.
                  </li>
                </ul>
              </div>
