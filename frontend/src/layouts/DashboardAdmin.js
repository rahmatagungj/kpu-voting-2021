    ...
    <main className="bg-gray-100 dark:bg-gray-800 h-screen overflow-hidden relative">
      ...
      <div className="shadow-lg bg-base-200 drawer drawer-mobile h-screen">
        ...
        <div className="flex flex-col drawer-content">
          <header
              className="bg-primary w-full h-13 z-40 flex items-center justify-between sticky top-0 z-50 shadow-sm sm:shadow-none p-2">
            <div className="block lg:hidden ml-3">
              <label htmlFor="my-drawer-2"
                ...
                <svg width="22" height="22" className="text-gray-400 hover:text-gray-700"
                     fill="#ffffff"
        ...
        <div className="border-r-2 drawer-side">
          ...
          <div className="menu p-4 overflow-y-auto w-72 bg-base-100 text-base-content">
            <div className="flex items-center justify-start pt-6 ml-8">
              <p className="font-bold dark:text-white text-xl">Komisi Pemilihan Umum</p>
            </div>
            <nav className="mt-6 border-t-2 border-fuchsia-600">
              <div>
                <Link className="w-full text-gray-800 dark:text-white flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start" to="/admin/dashboard">
                  <MdPeople size={20} />
                ...
                <Link className="w-full text-gray-800 dark:text-white flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start" to="/admin/dashboard/information">
                  <MdInfo size={20} />
